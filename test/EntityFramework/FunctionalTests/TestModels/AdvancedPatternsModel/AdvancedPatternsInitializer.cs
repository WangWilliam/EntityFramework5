        ...
        protected override void Seed(AdvancedPatternsMasterContext context)
        {
            var buildings = new List<Building>
            {
                new Building
                {
                    ...
                    Name = "Building One",
                    Value = 1500000m,
                    Address = new Address { Street = "100 Work St", City = "Redmond", State = "WA", ZipCode = "98052", SiteInfo = new SiteInfo { Zone = 1, Environment = "Clean"}},
                },
                new Building
                {
                    ...
                    Name = "Building Two",
                    Value = 1000000m,
                    Address = new Address { Street = "200 Work St", City = "Redmond", State = "WA", ZipCode = "98052", SiteInfo = new SiteInfo { Zone = 2, Environment = "Contaminated"}},
                },
            };
            ...
            new List<Employee>
            {
                new CurrentEmployee { EmployeeId = 1, FirstName = "Rowan", LastName = "Miller", LeaveBalance = 45, Office = offices[0] },
                new CurrentEmployee { EmployeeId = 2, FirstName = "Arthur", LastName = "Vickers", LeaveBalance = 62, Office = offices[1] },
                new PastEmployee { EmployeeId = 3, FirstName = "John", LastName = "Doe", TerminationDate = new DateTime(2006, 1, 23) },
