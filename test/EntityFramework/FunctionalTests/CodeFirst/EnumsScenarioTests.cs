namespace FunctionalTests
{
    ...
    public sealed class EnumsScenarioTests : TestBase
    {
        ...
        public void Simple_enum_mapping_scenario()
        {
            ...
            Assert.Equal(EdmPrimitiveTypeKind.Int32, enumType.UnderlyingType.PrimitiveTypeKind);
        }
        ...
        public void Short_enum_mapping_with_flags_attribute()
        {
            ...
            Assert.Equal(EdmPrimitiveTypeKind.Int16, enumType.UnderlyingType.PrimitiveTypeKind);
        }
        ...
        public void Annotated_nullable_enum_inside_complex_type_is_mapped()
        {
            ...
            databaseMapping.Assert<Enum_ComplexType>(c => c.Enum).IsTrue(t => t.IsNullable);
        ...
        public void Fluent_api_configured_enum_property_gets_correct_facets()
        {
            ...
            databaseMapping.AssertValid();
            databaseMapping.Assert<Enum_Product>(p => p.CategoryId).IsTrue(p => p.IsNullable);
        }
        ...
        public void Empty_enum_in_model_does_not_fail_validation()
        {
            ...
            var databaseMapping = BuildMapping(modelBuilder);
            databaseMapping.AssertValid();
            databaseMapping.Assert<Enum_Empty>(p => p.Empty).IsFalse(e => e.ChildItems.Any());
        }
