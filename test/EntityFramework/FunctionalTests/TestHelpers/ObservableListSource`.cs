namespace System.Data.Entity
{
    ...
    [SuppressMessage("Microsoft.Naming", "CA1710:IdentifiersShouldHaveCorrectSuffix", Justification = "Adding Collection makes the name too long.")]
    public class ObservableListSource<T> : ObservableCollection<T>, IListSource where T : class
    {
        ...
        /// </summary>
        /// <returns>
        /// An <see cref="IBindingList"/> implementation that stays in sync with this <see cref="ObservableCollection{T}"/>.
        /// </returns>
