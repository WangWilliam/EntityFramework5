namespace System.Data.Entity.Core.Common.CommandTrees
{
    ...
    public class BasicExpressionVisitorTests
    {
        [Fact]
        ...
        public class ConcreteExpressionVisitor : BasicExpressionVisitor
        {
        }

        private static void TestVisitNull(Action<BasicExpressionVisitor> test)
        {
