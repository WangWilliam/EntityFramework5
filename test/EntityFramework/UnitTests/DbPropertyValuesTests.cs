namespace ProductivityApiUnitTests
{
    ...
    public class DbPropertyValuesTests : TestBase
    {
        ...
        public class FakeTypeWithProps
        {
            ...
            public FakeTypeWithProps(int id, string publicStringProp, string privateStringProp,
            ...
            public virtual string PublicReadonlyStringProp { get { return "PublicReadonlyStringProp"; } }
            private string PrivateReadonlyStringProp { get { return "PrivateReadonlyStringProp"; } }

            public virtual string PublicWriteOnlyStringProp { set { } }
            private string PrivateWriteOnlyStringProp { set { } }
        ...
        public void ToObject_sets_all_properties_from_the_dictionary_onto_the_object_including_those_with_private_setters()
        {
            ...
            Assert.Equal("PrivateStringPropValue", typeof(FakeTypeWithProps).GetProperty("PrivateStringProp", PropertyBindingFlags).GetValue(clone, null));
            ...
            Assert.Equal(5, typeof(FakeTypeWithProps).GetProperty("PublicIntPropWithPrivateGetter", PropertyBindingFlags).GetValue(clone, null));
        ...
        {
            var properties = new Dictionary<string, object> { {"Id", 1}, {"MissingProp", "MissingPropValue"} };
            var values = new TestInternalPropertyValues<FakeTypeWithProps>(properties);
        ...
        {
            var properties = new Dictionary<string, object> { { "Id", 1 }, { "PublicReadonlyStringProp", "Foo" }, { "PrivateReadonlyStringProp", "Foo" } };
            var values = new TestInternalPropertyValues<FakeTypeWithProps>(properties);
            ...
            Assert.Equal("PrivateReadonlyStringProp", typeof(FakeTypeWithProps).GetProperty("PrivateReadonlyStringProp", PropertyBindingFlags).GetValue(clone, null));
        }

        [Fact]
        public void ToObject_can_set_reference_propeties_to_null()
        {
            var properties = new Dictionary<string, object> { { "PublicNonNullStringProp", null } };
            var values = new TestInternalPropertyValues<FakeTypeWithProps>(properties);
        ...
        {
            var nestedProperties = new Dictionary<string, object> { { "Id", 1 } };
            var nestedValues = new TestInternalPropertyValues<FakeTypeWithProps>(nestedProperties);

            var properties = new Dictionary<string, object> { { "NestedObject", nestedValues } };
        ...
        {
            var properties = new Dictionary<string, object> { { "Id", 1 }, { "NestedObject", null } };
            var values = new TestInternalPropertyValues<FakeTypeWithProps>(properties, new[] { "NestedObject" });
        ...
        {
            var values = new TestInternalPropertyValues<FakeTypeWithProps>(new Dictionary<string, object> { { "Id", 1 } });
            values["Id"] = null;

            Assert.Equal(Strings.DbPropertyValues_CannotSetNullValue("Id", "Int32", "FakeTypeWithProps"), Assert.Throws<InvalidOperationException>(() => values.ToObject()).Message);
        }
        ...
        public void SetValues_copies_values_from_object_to_property_dictionary()
        {
            ...
            var obj = new FakeTypeWithProps(1, "PublicStringPropValue", "PrivateStringPropValue", 2, 3, 4, 5, new byte[] { 3, 1, 4, 1, 5, 9 });
        ...
        {
            Attempt_to_copy_values_from_object_of_differnt_type_copies_only_properties_that_match_implementation(new FakeTypeWithSomeProps("PublicStringPropValue", 3, 4));
        }

        [Fact]
        public void Attempt_to_copy_values_from_anonymous_object_copies_only_properties_that_match()
        {
            var obj = new {PublicStringProp = "PublicStringPropValue", PrivateIntProp = 3, SomeDifferentIntProp = 4};
        ...
        {
            var properties = new Dictionary<string, object> { {"Id", 0} };
            var values = new DbPropertyValues(new TestInternalPropertyValues<FakeTypeWithProps>(properties));

            values.SetValues(new FakeTypeWithProps {Id = 1});
        ...
        public void Calling_SetValues_with_instance_of_derived_type_works()
        {
            ...
            values.SetValues(new FakeDerivedTypeWithProps { Id = 1 });
        ...
        {
            var properties = new Dictionary<string, object> { { "Id", 0 }, { "MissingProp", "MissingPropValue" } };
            var values = new TestInternalPropertyValues<FakeTypeWithProps>(properties);
        ...
        {
            var properties = new Dictionary<string, object> { { "Id", 0 }, { "PublicWriteOnlyStringProp", "Foo" }, { "PrivateWriteOnlyStringProp", "Bar" } };
            var values = new TestInternalPropertyValues<FakeTypeWithProps>(properties);
        ...
        {
            var properties = new Dictionary<string, object> { { "Id", 0 }, { "PublicStringProp", "NonNull" } };
            var values = new TestInternalPropertyValues<FakeTypeWithProps>(properties);
        ...
        {
            var nestedProperties = new Dictionary<string, object> { { "Id", 0 } };
            var nestedValues = new TestInternalPropertyValues<FakeTypeWithProps>(nestedProperties);

            var properties = new Dictionary<string, object> { { "Id", 0 }, { "NestedObject", nestedValues } };
            var values = new TestInternalPropertyValues<FakeTypeWithProps>(properties, new[] { "NestedObject" });

            values.SetValues(new FakeTypeWithProps { Id = 1, NestedObject = new FakeTypeWithProps { Id = 2 } });
        ...
        public void SetValues_when_complex_object_is_null_throws()
        {
            ...
            var obj = new FakeTypeWithProps { Id = 1, NestedObject = null };

            Assert.Equal(Strings.DbPropertyValues_ComplexObjectCannotBeNull("NestedObject", typeof(FakeTypeWithProps).Name), Assert.Throws<InvalidOperationException>(() => values.SetValues(obj)).Message);
        }

        [Fact]
        public void SetValues_when_nested_property_dictionary_in_source_is_null_throws()
        {
            var properties = new Dictionary<string, object> { { "Id", 0 }, { "NestedObject", null } };
            var values = new TestInternalPropertyValues<FakeTypeWithProps>(properties, new[] { "NestedObject" });

            var obj = new FakeTypeWithProps { Id = 1, NestedObject = new FakeTypeWithProps { Id = 2 } };

            Assert.Equal(Strings.DbPropertyValues_NestedPropertyValuesNull("NestedObject", typeof(FakeTypeWithProps).Name), Assert.Throws<InvalidOperationException>(() => values.SetValues(obj)).Message);
        }
        ...
        {
            var nestedProperties = new Dictionary<string, object> { { "Id", 2 } };
            var nestedValues = new TestInternalPropertyValues<FakeTypeWithProps>(nestedProperties);

            var properties = new Dictionary<string, object> { { "Id", 1 }, { "NestedObject", nestedValues } };
            var values = new TestInternalPropertyValues<FakeTypeWithProps>(properties, new[] { "NestedObject" });
        ...
        public void Attempt_to_copy_values_from_null_dictionary_on_non_generic_DbPropertyValues_throws()
        {
            ...
            Assert.Equal("propertyValues", Assert.Throws<ArgumentNullException>(() => values.SetValues((DbPropertyValues)null)).ParamName);
        }
        ...
        public void Attempt_to_copy_values_from_dictionary_of_wrong_type_throws()
        {
            ...
            Assert.Equal(Strings.DbPropertyValues_AttemptToSetValuesFromWrongType(typeof(FakeTypeWithProps).Name, typeof(FakeDerivedTypeWithProps).Name), Assert.Throws<ArgumentException>(() => values1.SetValues(values2)).Message);
        }
        ...
        public void SetValues_when_nested_dictionary_is_for_wrong_type_throws()
        {
            ...
            Assert.Equal(Strings.DbPropertyValues_AttemptToSetValuesFromWrongType(typeof(FakeTypeWithProps).Name, typeof(FakeDerivedTypeWithProps).Name), Assert.Throws<ArgumentException>(() => toValues.SetValues(fromValues)).Message);
        }
        ...
        public void SetValues_when_nested_dictionary_in_source_is_null_throws()
        {
            ...
            var fromProperties = new Dictionary<string, object> { { "NestedObject", null } };
            var fromValues = new TestInternalPropertyValues<FakeTypeWithProps>(fromProperties, new[] { "NestedObject" });

            var toProperties = new Dictionary<string, object> { { "NestedObject", nestedValues } };
            var toValues = new TestInternalPropertyValues<FakeTypeWithProps>(toProperties, new[] { "NestedObject" });

            Assert.Equal(Strings.DbPropertyValues_NestedPropertyValuesNull("NestedObject", typeof(FakeTypeWithProps).Name), Assert.Throws<InvalidOperationException>(() => toValues.SetValues(fromValues)).Message);
        }
        ...
        public void SetValues_when_nested_dictionary_in_target_is_null_throws()
        {
            ...
            var fromProperties = new Dictionary<string, object> { { "NestedObject", nestedValues } };
            var fromValues = new TestInternalPropertyValues<FakeTypeWithProps>(fromProperties, new[] { "NestedObject" });

            var toProperties = new Dictionary<string, object> { { "NestedObject", null } };
            var toValues = new TestInternalPropertyValues<FakeTypeWithProps>(toProperties, new[] { "NestedObject" });
        ...
        public void Reading_value_from_non_generic_DbPropertyValues_for_a_null_property_name_throws()
        {
            ...
            Assert.Equal(Strings.ArgumentIsNullOrWhitespace("propertyName"), Assert.Throws<ArgumentException>(() => { var _ = values[null]; }).Message);
        }
        ...
        public void Reading_value_from_non_generic_DbPropertyValues_for_an_empty_property_name_throws()
        {
            ...
            Assert.Equal(Strings.ArgumentIsNullOrWhitespace("propertyName"), Assert.Throws<ArgumentException>(() => { var _ = values[""]; }).Message);
        }
        ...
        public void Reading_value_for_a_missing_property_name_throws()
        {
            ...
            Assert.Equal(Strings.DbPropertyValues_PropertyDoesNotExist("NoSuchProperty", typeof(FakeTypeWithProps).Name), Assert.Throws<ArgumentException>(() => { var _ = values["NoSuchProperty"]; }).Message);
        }
        ...
        {
            var values = new TestInternalPropertyValues<FakeTypeWithProps>(new Dictionary<string, object> { { "Id", 0 } });
        ...
        {
            SettingNestedValuesTest((values, nestedValues) => new DbPropertyValues(values)["NestedObject"] = new DbPropertyValues(nestedValues));
        }
        ...
        private void SettingNestedValuesTest(Action<InternalPropertyValues, InternalPropertyValues> bagger)
        {
            ...
            var newNestedProperties = new Dictionary<string, object> { { "Id", 1 } };
        ...
        public void Complex_values_cannot_be_set_to_null_in_a_property_dictionary()
        {
            ...
            Assert.Equal(Strings.DbPropertyValues_AttemptToSetNonValuesOnComplexProperty, Assert.Throws<ArgumentException>(() => values["NestedObject"] = null).Message);
        }
        ...
        public void Complex_values_cannot_be_set_to_actual_complex_object_instance_in_a_property_dictionary()
        {
            ...
            Assert.Equal(Strings.DbPropertyValues_AttemptToSetNonValuesOnComplexProperty, Assert.Throws<ArgumentException>(() => values["NestedObject"] = new FakeTypeWithProps()).Message);
        }

        [Fact]
        public void Writing_values_to_non_generic_DbPropertyValues_uses_the_internal_dictionary()
        {
            var values = new DbPropertyValues(new TestInternalPropertyValues<FakeTypeWithProps>(new Dictionary<string, object> { { "Id", 0 } }));
        ...
        public void Writing_values_to_non_generic_DbPropertyValues_for_a_null_property_name_throws()
        {
            ...
            Assert.Equal(Strings.ArgumentIsNullOrWhitespace("propertyName"), Assert.Throws<ArgumentException>(() => values[null] = 0).Message);
        }
        ...
        public void Writing_values_to_a_missing_property_name_throws()
        {
            ...
            Assert.Equal(Strings.DbPropertyValues_PropertyDoesNotExist("NoSuchProperty", typeof(FakeTypeWithProps).Name), Assert.Throws<ArgumentException>(() => values["NoSuchProperty"] = 0).Message);
        }
        ...
        {
            var properties = new Dictionary<string, object> { { "One", 1 }, { "Two", 2 }, { "Three", 3 } };
            var values = new TestInternalPropertyValues<FakeTypeWithProps>(properties);
        ...
        public void ReadOnlyHashSet_is_readonly_and_throws_for_mutating_methods()
        {
            ...
            Assert.Equal(Strings.DbPropertyValues_PropertyValueNamesAreReadonly, Assert.Throws<NotSupportedException>(() => ((ICollection<string>)set).Add("")).Message);
            Assert.Equal(Strings.DbPropertyValues_PropertyValueNamesAreReadonly, Assert.Throws<NotSupportedException>(() => set.Add("")).Message);
            Assert.Equal(Strings.DbPropertyValues_PropertyValueNamesAreReadonly, Assert.Throws<NotSupportedException>(() => set.Clear()).Message);
            Assert.Equal(Strings.DbPropertyValues_PropertyValueNamesAreReadonly, Assert.Throws<NotSupportedException>(() => set.Remove("")).Message);
        }
