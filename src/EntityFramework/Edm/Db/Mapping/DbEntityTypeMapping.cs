namespace System.Data.Entity.Edm.Db.Mapping
{
    ...
    /// <summary>
    ///     Allows the construction and modification of a complete or partial mapping of an EDM entity type ( <see cref = "EdmEntityType" /> ) or type hierarchy to a specific database table ( <see cref = "DbTableMetadata" /> ).
    /// </summary>
        ...
        : DbMappingMetadataItem
    {
        ...
        /// <summary>
        ///     Gets or sets a value indicating whether this type mapping applies to <see cref = "EntityType" /> and all its direct or indirect subtypes ( <code>true</code> ), or only to <see cref = "EntityType" /> ( <code>false</code> ).
        /// </summary>
