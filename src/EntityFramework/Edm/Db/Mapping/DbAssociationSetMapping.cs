namespace System.Data.Entity.Edm.Db.Mapping
{
    ...
    internal class DbAssociationSetMapping : DbMappingMetadataItem
    {
        ...
        /// <summary>
        ///     Gets the collection of <see cref = "DbColumnCondition" /> s that specifies the constant or null values that columns in <see cref = "Table" /> must have for this type mapping to apply.
        /// </summary>
