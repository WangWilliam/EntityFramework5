namespace System.Data.Entity.Infrastructure
{
    ...
    public static class IDbAsyncQueryProviderExtensions
    {
        ...
        static public Task<object> ExecuteAsync(this IDbAsyncQueryProvider provider, Expression expression)
        {
        ...
        /// <param name="cancellationToken">The token to monitor for cancellation requests.</param>
        static public Task<TResult> ExecuteAsync<TResult>(this IDbAsyncQueryProvider provider, Expression expression)
        {
